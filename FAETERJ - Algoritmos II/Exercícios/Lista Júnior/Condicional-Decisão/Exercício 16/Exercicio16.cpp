...
main()
{
    ...
    if ((n1+n2)/2 >= 3 && (n1+n2)/2 < 7)
    {
        printf("Primeira nota = %.1f, segunda nota = %.1f, media = %.1f, Em Exame Final\n",n1,n2,(n1+n2)/2);
    }
    ...
    if ((n1+n2)/2 >= 3 && (n1+n2)/2 < 7)
    {
        cout << "Primeira nota = " << n1 << ", segunda nota = " << n2 << ", media = " << (n1+n2)/2 << ", Em Exame Final" << endl;
    }
    if ((n1+n2)/2 >= 0 && (n1+n2)/2 < 3)
    {
